namespace Team9_AD.Model
{
    ...
    public partial class Logic_University : DbContext
    {
        public Logic_University()
            : base("name=Logic_University")
        {
        }
        ...
        public virtual DbSet<Request_completed> Request_completed { get; set; }
        ...
        public virtual DbSet<Supplier_Goods_received> Supplier_Goods_received { get; set; }
